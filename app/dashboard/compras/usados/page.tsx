...
import { getComprasUsadas } from "@/lib/actions/compras-usado"
import type { CompraUsadaRow } from "@/lib/actions/compras-usado"
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 py-6 sm:px-6 lg:px-8">
        ...
        <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          >
            <Plus className="h-4 w-4" /> Nueva adquisición
          </Button>
        </header>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="rounded-2xl border border-slate-200 bg-white p-5">
            ...
            <p className="text-[10px] text-slate-400 mt-0.5">{stats.count} unidades en inventario histórico</p>
          </div>
          <div className="rounded-2xl border border-slate-200 bg-white p-5">
        ...
        <div className="rounded-3xl border border-slate-200 bg-white overflow-hidden shadow-sm">
          ...
          <div className="hidden lg:grid grid-cols-[1fr_1fr_1.5fr_140px_140px] gap-4 px-6 py-4 border-b border-slate-100">
            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">Bitácora / Temporalidad</span>
            ...
            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400 text-right">Jurisdicción</span>
          </div>
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center gap-4 py-20">
              ...
              <p className="text-sm font-bold text-slate-600 uppercase tracking-wider">Archivo vacío en este momento</p>
              <p className="text-xs text-slate-400">Registra tu primera adquisición de equipo usado.</p>
            </div>
          ) : (
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1 mt-2">
                  <p className="text-[11px] font-bold text-amber-700">
                    01. Registro de declaración jurada instantáneo.
                  </p>
                  <p className="text-[11px] font-bold text-amber-700">
                    02. Reporte en formato carta o térmico.
                  </p>
                  <p className="text-[11px] font-bold text-amber-700">
                    03. Exigencia de documentación física y huella.
                  </p>
                  <p className="text-[11px] font-bold text-amber-700">
                    04. Modificación de marco legal en ajustes.
                  </p>
                </div>
              </div>
            </div>
