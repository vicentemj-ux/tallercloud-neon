  ...
  if (!token) {
    return (
      <div className="min-h-[100dvh] bg-slate-50 flex items-center justify-center px-4">
        <p className="text-slate-600">Enlace no válido.</p>
      </div>
    )
  }
    ...
    <div className="min-h-[100dvh] bg-gradient-to-b from-slate-50 to-white px-4 py-8">
      <div className="mx-auto max-w-lg">
        ...
        <p className="mt-2 text-center text-sm text-slate-600">
          Firma en el recuadro con tu dedo o el mouse. Luego envía para confirmar que recibes el equipo en el taller.
        </p>
