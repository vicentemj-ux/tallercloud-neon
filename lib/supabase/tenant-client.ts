 ...
 * en los claims. Las políticas RLS usan `(auth.jwt()->>'taller_id')::uuid`
 * para aislar datos por tenant.
 *
 * Usar en Server Actions en lugar de createAdminClient() para que RLS
 * sea la línea de defensa a nivel de base de datos.
 *
...
/**
 * Helper para Server Actions: obtiene el tallerId de la sesión y crea
